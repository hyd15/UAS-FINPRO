...
if( isset($_POST['submit']) ){
        ...
        $lokasi    = stripslashes($_POST['lokasi']);
        ...
        if(!empty(trim($name)) && !empty(trim($username)) && !empty(trim($email)) && !empty(trim($umur)) && !empty(trim($lokasi)) && !empty(trim($password)) && !empty(trim($repass))){
            ...
            if($password == $repass){
                ...
                if( cek_nama($name,$con) == 0 ){
                    ...
                    $query = "INSERT INTO users (name,username,email,umur,lokasi, password ) VALUES ('$name','$username','$email','$umur','$lokasi','$pass')";
            ...
            <section class="col-12 col-sm-6 col-md-4">
                <form class="form-container" action="register.php" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="umur" class="form-control" id="Inputumur" name="umur" aria-describeby="umurHelp" placeholder="Masukkan umur">
                    </div>
                    <div class="form-group">
                        <label for="InputEmail">Alamat</label>
                        <input type="lokasi" class="form-control" id="Inputlokasi" name="lokasi" aria-describeby="lokasiHelp" placeholder="Masukkan Alamat">
                    </div>
                    <div class="form-group">
